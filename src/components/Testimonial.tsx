                    ...
                    <div className="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                        <div className="testimonial-item bg-light rounded p-5">
                            ...
                            <div className="d-flex align-items-center bg-white me-n5" style={{ borderRadius: "50px 0 0 50px" }}>
                                <img className="img-fluid flex-shrink-0 rounded-circle" src="src/assets/img/testimonial-1.jpg" style={{ width: "90px", height: "90px" }} />
                                <div className="ps-3">
                        ...
                        <div className="testimonial-item bg-light rounded p-5">
                            ...
                            <div className="d-flex align-items-center bg-white me-n5"
                                style={{ borderRadius: "50px 0 0 50px" }}
                            >
                                <img className="img-fluid flex-shrink-0 rounded-circle" src="src/assets/img/testimonial-3.jpg" style={{ width: "90px", height: "90px" }} />
                                <div className="ps-3">
                                    <h3 className="mb-1">Client Name</h3>
                                    <span>Profession</span>
                                </div>
