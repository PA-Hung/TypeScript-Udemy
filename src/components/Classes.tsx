                ...
                <div className="container">
                    ...
                    <div className="row g-4">
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="classes-item">
                                <div className="bg-light rounded-circle w-75 mx-auto p-3">
                                    <img className="img-fluid rounded-circle" src="src/assets/img/classes-1.jpg" alt="" />
                                </div>
                                <div className="bg-light rounded p-4 pt-5 mt-n5">
                                    ...
                                    <div className="d-flex align-items-center justify-content-between mb-4">
                                        <div className="d-flex align-items-center">
                                            <img className="rounded-circle flex-shrink-0" src="src/assets/img/user.jpg" alt="" style={{ width: "45px", height: "45px" }} />
                                            <div className="ms-3">
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div className="classes-item">
                                <div className="bg-light rounded-circle w-75 mx-auto p-3">
                                    <img className="img-fluid rounded-circle" src="src/assets/img/classes-2.jpg" alt="" />
                                </div>
                                <div className="bg-light rounded p-4 pt-5 mt-n5">
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div className="classes-item">
                                <div className="bg-light rounded-circle w-75 mx-auto p-3">
                                    <img className="img-fluid rounded-circle" src="src/assets/img/classes-3.jpg" alt="" />
                                </div>
                                <div className="bg-light rounded p-4 pt-5 mt-n5">
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="classes-item">
                                <div className="bg-light rounded-circle w-75 mx-auto p-3">
                                    <img className="img-fluid rounded-circle" src="src/assets/img/classes-4.jpg" alt="" />
                                </div>
                                <div className="bg-light rounded p-4 pt-5 mt-n5">
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div className="classes-item">
                                <div className="bg-light rounded-circle w-75 mx-auto p-3">
                                    <img className="img-fluid rounded-circle" src="src/assets/img/classes-5.jpg" alt="" />
                                </div>
                                <div className="bg-light rounded p-4 pt-5 mt-n5">
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div className="classes-item">
                                <div className="bg-light rounded-circle w-75 mx-auto p-3">
                                    <img className="img-fluid rounded-circle" src="src/assets/img/classes-6.jpg" alt="" />
                                </div>
                                <div className="bg-light rounded p-4 pt-5 mt-n5">
